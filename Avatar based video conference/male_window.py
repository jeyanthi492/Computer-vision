...
def next_window(win2,*ten):
    ...
    meet(win2,*ten)
def male_window(win1,cap):
    cap.release()
    def go_to_meet():
         avatar_create(combo_box1.get(),combo_box2.get(), combo_box3.get(), combo_box4.get(), combo_box5.get(),combo_box6.get(), combo_box7.get(), combo_box8.get(), combo_box9.get(), combo_box10.get())
    ...
    combo_box1.place(x=730,y=100)
    num1.set(list_skin_color[random.randrange(0,len(list_skin_color)-3)])

    num2 = StringVar()
    combo_box2 = Combobox(win2, values=list_top_type, textvariable=num2,width=70)
    combo_box2.place(x=730,y=150)
    num2.set(list_top_type[random.randrange(0, len(list_top_type)-12)])

    num3 = StringVar()
    combo_box3 = Combobox(win2, values=list_hat_color, textvariable=num3,width=70)
    combo_box3.place(x=730,y=200)
    num3.set(list_hat_color[random.randrange(0, len(list_hat_color))])
    ...
    num9 = StringVar()
    combo_box9= Combobox(win2, values=list_facial_hair_type, textvariable=num9,width=70)
    combo_box9.place(x=730,y=500)
    num9.set(list_facial_hair_type[random.randrange(0, len(list_facial_hair_type))])

    num10 = StringVar()
    combo_box10 = Combobox(win2, values=list_facial_hair_color, textvariable=num10,width=70)
    combo_box10.place(x=730,y=550)
    num10.set(list_facial_hair_color[random.randrange(0, len(list_facial_hair_color))])
    ...
    label3 = Label(win2, text="Hat Color")
    ...
    label9 = Label(win2, text="Facial Hair Type")
    label9.place(x=600, y=500)

    label10 = Label(win2, text="Facial Hair Color")
    label10.place(x=600, y=550)

    button1 = Button(win2, text="NEXT", background="red",command=lambda: next_window(win2, combo_box1.get(), combo_box2.get(), combo_box3.get(), combo_box4.get(),combo_box5.get(), combo_box6.get(), combo_box7.get(), combo_box8.get(),combo_box9.get(),combo_box10.get()), width=30, height=4)
    button1.place(x=850, y=620)
    go_to_meet()
    win2.mainloop()
